...
export const useChat = () => {
  ...
  const fetch = async (params: any): Promise<void> => {
    return chatApiClient.fetch(params).then((data: { paginate: Paginate, data: ChatApi[] }) => {
  ...
  const all = async (params: any): Promise<void> => {
    return chatApiClient.all(params).then((data: ChatApi[]) => {
  ...
  const find = async (id: string): Promise<void> => {
    return chatApiClient.find(id).then((data: ChatApi | null) => {
  ...
  const create = async (params: any): Promise<void> => {
    return chatApiClient.create(params).then((data: ChatApi | null) => {
      chat.value = data ? convertChatApiToChat(data) : null;
    }).catch((errorResponse: ErrorResponse) => {
      throw errorResponse
    })
  ...
  const update = async (id: string, params: any): Promise<void> => {
    return chatApiClient.update(id, params).then((data: ChatApi | null) => {
      chat.value = data ? convertChatApiToChat(data) : null;
    }).catch((errorResponse: ErrorResponse) => {
      throw errorResponse
    })
  ...
  const destroy = async (id: string): Promise<void> => {
    return chatApiClient.destroy(id).then(() => {
      chat.value = null;
    }).catch((errorResponse: ErrorResponse) => {
      throw errorResponse
    })
