...
export const useStudio = () => {
  ...
  const fetch = async (params: any): Promise<void> => {
    return studioApiClient.fetch(params).then((data: { paginate: Paginate, data: StudioApi[] }) => {
  ...
  const all = async (params: any): Promise<void> => {
    return studioApiClient.all(params).then((data: StudioApi[]) => {
  ...
  const find = async (id: string): Promise<void> => {
    return studioApiClient.find(id).then((data: StudioApi | null) => {
  ...
  const create = async (params: any): Promise<void> => {
    return studioApiClient.create(params).then((data: StudioApi | null) => {
      studio.value = data ? convertStudioApiToStudio(data) : null;
    }).catch((errorResponse: ErrorResponse) => {
      throw errorResponse
    })
  ...
  const update = async (id: string, params: any): Promise<void> => {
    return studioApiClient.update(id, params).then((data: StudioApi | null) => {
      studio.value = data ? convertStudioApiToStudio(data) : null;
    }).catch((errorResponse: ErrorResponse) => {
      throw errorResponse
    })
  ...
  const destroy = async (id: string): Promise<void> => {
    return studioApiClient.destroy(id).then(() => {
      studio.value = null;
    }).catch((errorResponse: ErrorResponse) => {
      throw errorResponse
    })
